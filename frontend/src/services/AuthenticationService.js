...
class AuthenticationService {
	...
	registerUserInSession(username, password) {
		...
		// check if setupAxiosInterceptors is being called and token is correctly generated
	...
	setupAxiosInterceptors(token) {		
		axios.interceptors.request.use(request => {
			...
			if (this.isUserLoggedIn()) {
				...
				//verify if the interceptor is correctly attaching the token:
				console.log("Token attached to request:", request.headers.authorization);
